  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['business:honor:edit']"
              >详情
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['business:honor:remove']"
              >删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['business:honor:export']">导出 </el-button>
          </el-col>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="详情" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['business:honor:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['business:honor:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="honorFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="荣誉类型" prop="honorTypeId">
          <el-select v-model="form.honorTypeId" placeholder="请选择荣誉类型" clearable style="width: 100%;" disabled>
            <el-option v-for="dict in types" :key="dict.honorTypeId" :label="dict.honorTypeName" :value="dict.honorTypeId" />
          </el-select>
        </el-form-item>
        <el-form-item label="荣誉名称" prop="honorName">
        ...
        <el-form-item label="佐证材料" prop="honorEvidenceUrl">
          <el-button type="success" link @click="download(form.honorEvidenceUrl);">点我下载</el-button>
        </el-form-item>
        <el-form-item label="审核反馈" prop="honorFeedback">
          <el-input v-model="form.honorFeedback" type="textarea" placeholder="请输入内容" disabled />
        </el-form-item>
        <el-form-item label="荣誉状态" prop="status">
          <el-select v-model="form.status" placeholder="请选择荣誉状态" clearable style="width: 100%;" disabled>
            <el-option v-for="dict in business_experience_type" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
...
import {
  ...
  getHonor,
  delHonor,
} from '@/api/business/honor';
import {HonorVO, HonorQuery, HonorForm} from '@/api/business/honor/types';
...
/** 导出按钮操作 */
const handleExport = () => {
  proxy?.download('business/honor/export', {
    ...queryParams.value
