  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['business:competition:edit']"
              >详情
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['business:competition:remove']"
              >删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['business:competition:export']">导出 </el-button>
          </el-col>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="详情" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['business:competition:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['business:competition:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="competitionFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="竞赛类型" prop="competitionTypeId">
          <el-select v-model="form.competitionTypeId" placeholder="请选择竞赛类型" clearable style="width: 100%;" disabled>
            <el-option v-for="dict in types" :key="dict.competitionTypeId" :label="dict.competitionTypeName" :value="dict.competitionTypeId" />
          </el-select>
        </el-form-item>
        <el-form-item label="竞赛名称" prop="competitionName">
        ...
        <el-form-item label="佐证材料" prop="competitionEvidenceUrl">
          <el-button type="success" link @click="download(form.competitionEvidenceUrl);">点我下载</el-button>
        </el-form-item>
        <el-form-item label="审核反馈" prop="competitionFeedback">
          <el-input v-model="form.competitionFeedback" type="textarea" placeholder="请输入内容" disabled />
        </el-form-item>
        <el-form-item label="竞赛状态" prop="status">
          <el-select v-model="form.status" placeholder="请选择竞赛状态" clearable style="width: 100%;" disabled>
            <el-option v-for="dict in business_experience_type" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
...
import {
  ...
  getCompetition,
  delCompetition,
} from '@/api/business/competition';
import {CompetitionVO, CompetitionQuery, CompetitionForm} from '@/api/business/competition/types';
...
/** 导出按钮操作 */
const handleExport = () => {
  proxy?.download('business/competition/export', {
    ...queryParams.value
